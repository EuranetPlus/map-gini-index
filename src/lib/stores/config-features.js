export const config = {
	mapTitle: 'map-gini-index', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-gini-index.vercel.app/', // The url provided when deploying the map on Vercel
